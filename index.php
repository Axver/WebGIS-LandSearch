...
<body onload="checklat()" id="page-top" style="background-color: #ffffff;">
    ...
    <!-- Header -->
    <div class="masthead bg-primary text-white text-center" style="background-color:#ffffff; padding-left:20px; padding-right:20px;">
    ...
    <!-- Footer -->
    <footer style="background-color:#b38f00;" class="footer text-center">
    <div class="container">
    <div class="row">
    ...
    <div class="col-md-4">
        ...
        <p class="lead mb-0">AndaLand is a market-place that trades land that are all over Indonesia. By using AndaLand, you can see lands that are suitable for your needs. .</p>
    </div>
    </div>
    </div>
    </footer>
