...
<body id="page-top">
  ...
  <nav style="background-color:#6c2b0f;" class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.php">ANDALAND</a>
      ...
      <div style="background-color:#6c2b0f;" class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" onclick="testsaja()" id='sample1' href="#">LOGIN</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
 ...
 function refresh()
 {
  ...
  <!-- Footer -->
  <footer style="background-color:#ddb786;" class="footer text-center">
    <div class="container">
      <div class="row">
