...
<html lang="en">
	...
	<script type="text/javascript" src="../plugin_weather/leaflet-openweathermap.js"></script>
	...
	<div class="col-sm-2">
	<select id="fasilitas" onchange="carifasilitas()" class="form-control">
	<option>
	Rumah Sakit
	</option>
	<option>
   ...
   for(i=0;i<5;i++)
	...
	{
		var pilihan=document.getElementById("fasilitas").value;
		if (a=="0")
		{
			swal("Pilih Posisi Anda Terlebih Dahulu!")
		}
			...
			if(pilihan=="Halte")
				{
					swal("Menampilkan Halte Terdekat dari Lokasi");
				}
				else if(pilihan=="Rumah Sakit")
				{
					swal("Menampilkan Rumah Sakit Terdekat dari Lokasi");
				}
		}
