...
<body id="page-top">
  ...
  <script type="text/javascript">
    var mymap = L.map('mapid').setView([-6.282250, 106.801443], 8);
  ...
  <!-- Fungsi Javascript Ambil data -->
  <script>
  var argeojson = <?php echo json_encode($hasil) ?>;
  // var poli=L.geoJSON(argeojson).addTo(mymap);
  var poli;
  console.log(argeojson);


for(var i = 0; i < argeojson.features.length; i++){
    if (argeojson.features[i].properties.gid %2==0 && argeojson.features[i].properties.gid<=100 ) {
    ...
    else if(argeojson.features[i].properties.gid %2==0 && argeojson.features[i].properties.gid>100 )
    {
...
<!-- Drawable maps layer -->
  ...
  var layer_GEOLOGI = new L.GeoJSON.AJAX("../sy_proses/pr_parsing.php",{ // layer geologi berada di dalam variabel layer_geologi
      style: function(feature){
        var fillColor="#ffd700"; // ini style yang akan digunakan
