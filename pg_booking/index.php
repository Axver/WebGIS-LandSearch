...
<body onload="myFunction()" id="page-top" style="background-color:#ffffff;">
...
<nav style="background-color:#f4edbd; height:70px;" class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    ...
    <div style="background-color:#f4edbd;" class="collapse navbar-collapse" id="navbarResponsive" >
            ...
            <div class="container">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><button class="button "disabled>Cari Notaris</button></td>
                        <td><img style="width:50px; height:50px; margin-left:5px;" src="../image/3.png"> <button onclick="biddingpage()" class="btnbid btn1bid ">BID NOW </button></td>
                        <td>2 hours left</td>
                    </tr>
                    <tr>
                        <td>0000000002</td>
                        <td>Belum Disetujui</td>
                        <td><button class="button "disabled>Cari Notaris</button></td>
                        <td><img style="width:50px; height:50px; margin-left:5px;" src="../image/2.png"> <button onclick="biddingpage()" class="btnbid btn1bid">BID NOW </button></td>
                        <td>2 hours left</td>
                    </tr>
                    <tr>
                        <td>0000000003</td>
                        <td>Sudah Disetujui</td>
                        <td><button class="button button1" onclick="carinotaris()">Cari Notaris </td>
        ...
        <div id="gallery" onload="hilang()">
            ...
            <div id="gallery-saya" class="container">
                <div class="filter_notaris" style="height:100px;">
                    ...
                    <button onclick="tampilnotaris()" type="button" class="button button1" name="button">Lihat Semua Notaris</button>
                </div>
                <div class="row">
                    <div class="column">
                        <div class="card">
                            ...
                            <div class="container">
                                <h2>Jane Doe</h2>
                                <br>
                                <p class="title">janedoe@example.com</p>
                                ...
                                <p><button class="button">Choose</button></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="column">
                        <div class="card">
                            ...
                            <div class="container">
                                <h2>Mike Ross</h2>
                                <br>
                                <p class="title">mikee@example.com</p>
                                <p>Some text that describes me lorem ipsum ipsum lorem.</p>
                                <div style="margin: 30px 0;">
                                    <a href="#"><i class="fa fa-dribbble"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
